...
class LinkExtractor:
    ...
    def extract_links(self, content: str, content_type: str = "auto", base_url: str = None) -> List[str]:
        """
    ...
    def _detect_content_type(self, content: str) -> str:
        ...
        if '<html' in content.lower() or '<body' in content.lower() or '<a href' in content.lower():
            return "html"
        return "text"
