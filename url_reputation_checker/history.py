...
from .models import DomainHistory
...
class DomainHistoryChecker:
                ...
                try:
                    ...
                    if oldest and hasattr(oldest, 'timestamp'):
                        ...
                        if len(ts) >= 8:
                            ...
                            month = ts[4:6]
                            day = ts[6:8]
                            oldest_date = datetime(int(year), int(month), int(day), tzinfo=timezone.utc)
                except:
                    oldest_date = None
    ...
    def calculate_reputation_score(self, 
                                 ...
                                 validation_result: 'URLValidationResult') -> float:
        """
